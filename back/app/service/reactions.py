    ...
    async def react(self, user, params):
        ...
        try:
            ...
            async with aiohttp.ClientSession() as session:
                ...
                data = {"name": params["name"], "private": True}
...
class PlaySongReaction(IReaction):
    ...
    async def react(self, user, params):
        ...
        response = requests.put(
            "https://api.spotify.com/v1/me/player/play", headers=headers, json=body
        )
        ...
        if response.status_code == 204:
            ...
            print(
                f"Failed to play track: {response.status_code} {response.text}",
                flush=True,
            )
...
class AddToPlaylistReaction(IReaction):
    ...
    async def react(self, user, params):
        ...
        if response.status_code == 201:
            ...
            print(
                f"Failed to add track: {response.status_code} {response.text}",
                flush=True,
            )
